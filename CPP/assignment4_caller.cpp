...
void question3_caller(const std::vector<int>& input1, const std::vector<int>& input2) {
...
int main(int argc, char** argv) {
    ...
    if (all_args[1] == "question1")
        ...
        question3_caller(str_to_int_vector(all_args[2]), str_to_int_vector(all_args[3]));
