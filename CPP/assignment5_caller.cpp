...
void question2_caller(const std::string& input1, int input2) {
    int output = question2(input1, input2);
    std::cout << "Question2: " << output << std::endl;
}

void question3_caller(const std::string& input1, const std::string& input2) {
...
int main(int argc, char** argv) {
    ...
    if (all_args[1] == "question1")
        ...
        question2_caller(all_args[2], std::stoi(all_args[3]));

    else if (all_args[1] == "question3")
        question3_caller(all_args[2], all_args[3]);
