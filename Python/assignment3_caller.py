...
import sys
from utils import str_to_2d_int_list
...
def question2_caller(input1: str, input2: int):
    output = question2(input1, input2)
    print(f"Question2: {output}")


def question3_caller(input1: list[list[int]]):
...
def main():
    ...
    if sys.argv[2] == "question1":
        ...
        question2_caller(sys.argv[3], int(sys.argv[4]))

    elif sys.argv[2] == "question3":
        question3_caller(str_to_2d_int_list(sys.argv[3]))
