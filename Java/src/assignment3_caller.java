    ...
    public static void main(String[] args) {
        switch (args[0]) {
            ...
            case "question2":
            	...
            	break;
            case "question3":
            	question3_caller(utils.str_to_2d_int_array(args[1]));
            	break;
            default:
